...
> `vendor/nakon` (pinned to a release; currently v0.1.6). For agent/integration context see
> **[AGENTS.md](AGENTS.md)**.
...
| `vendor/nakon/` | Submodule (v0.1.6) — CLI only (`randomize`/`build`/`deploy`), bundles under `bundles/`. |
